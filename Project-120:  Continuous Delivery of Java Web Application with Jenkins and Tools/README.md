...
```sh
git clone -b ci-jenkins git@github.com:DOGAN2010/vprofile-project.git
```
...
sudo -i
sudo su - jenkins
git ls-remote -h -- git@github.com:DOGAN2010/vprofile-project.git HEAD
```
...
```sh
https://github.com/DOGAN2010/vprofile-project.git
```
